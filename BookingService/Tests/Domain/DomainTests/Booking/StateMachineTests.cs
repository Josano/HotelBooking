...
namespace DomainTests.Bookings
{
    public class Tests
    {
        ...
        [Test]
        public void ShouldSetStatusToPayingForBookingWithCreatedStatus()
        {
            var booking = new Booking();
        ...
        [Test]
        public void ShouldSetStatusToRefoundedFinishedWhenRefoundingAPaidBooking()
        {
            var booking = new Booking();
        ...
        [Test]
        public void ShouldNotChangeStatusWhenRefoundingBookingWithCreatedStatus()
        {
            var booking = new Booking();
